    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
          ¿Qué desventajas tiene usar la fórmula aproximada?
        </a>
      </h4>
    </div>
    ...
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro">
          ¿Qué ventajas tiene usar la fórmula exacta?
        </a>
      </h4>
    </div>
    <div id="collapseCuatro" class="panel-collapse collapse ">
      <div class="panel-body">
        La ventaja es que se está utilizando la fórmula que directamente aplica el tipo anual efectivo (unidad de medida universal del tipo de interés). Esta fórmula es beneficiosa para el hipotecado ya que si los tipos de interés suben, los intereses no crecerán tanto.
...
<span class="glyphicon glyphicon-user iconouser"></span>
	...
	<script>
	  ...
	  ga('create', 'UA-46615807-1', 'ax5.org');
	  ga('send', 'pageview');
